								...
								<tr class="table_row">
									...
									<td class="column-4">
										...
										<div class="wrap-num-product flex-w m-l-auto m-r-0">
											...
											<input
											name="quantity" class="mtext-104 cl3 txt-center num-product" type="number" name="num-product1" value="<?php echo $value['quantity']?>">
						...
						<div class="flex-w flex-t bor12 p-t-15 p-b-30">
							...
							<div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
								<p class="stext-111 cl6 p-t-2">
									We will deliver anywhere through our delivery partners. <br>

									No fast delivery option available right now.
								</p>
