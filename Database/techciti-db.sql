...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1643762907ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=techciti-db&table=order_details">`techciti-db`.`order_details`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=techciti-db&table=orders">`techciti-db`.`orders`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=techciti-db&table=customers">`techciti-db`.`customers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=techciti-db&table=admins">`techciti-db`.`admins`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=techciti-db&table=contact">`techciti-db`.`contact`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=feedback_system&table=user">`feedback_system`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=techciti-db&table=categories">`techciti-db`.`categories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=techciti-db&table=products">`techciti-db`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=phpstore&table=products">`phpstore`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ecom_store&table=admins">`ecom_store`.`admins`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="4c7479596277697676762144264c734f">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="techciti-db" targettable="order_details">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `order_details`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="techciti-db" targettable="contact">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `contact`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="techciti-db" targettable="customers">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `customers`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="techciti-db" targettable="orders">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `customers`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="techciti-db" targettable="admins">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
