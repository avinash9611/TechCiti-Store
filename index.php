		...
		<div class="container">
			...
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					...
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".1" id="t_shirt">
						T Shirt
					</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".2" id="shirt">
						Shirt
					</button>
					...
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".4" id="accessories">
						Accessories
					</button>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <?php echo $final['category_id'] ?>">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="uploads/<?php echo $final['picture'] ?>" alt="IMG-PRODUCT" style="min-height: 350px; max-height:350px;">
